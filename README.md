...
> Go to the [Getting Started page](https://spendif.ai/getting-started.html) for the illustrated install + first-launch guide. This README is for developers and contributors.
>
...
| Release process | internal document, not published |
